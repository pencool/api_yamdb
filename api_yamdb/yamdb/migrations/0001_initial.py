# Generated by Django 3.2 on 2022-12-28 06:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Администратор', 'admin'), ('Модератор', 'moderator'), ('Пользователь', 'user')], default='user', max_length=50)),
